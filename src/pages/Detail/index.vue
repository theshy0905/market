          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuvalue.isChecked == 1 }"
                  v-for="spuvalue in spuSaleAttr.spuSaleAttrValueList" :key="spuvalue.id"
                  @click="changeActive(spuvalue, spuSaleAttr.spuSaleAttrValueList)">{{
                    spuvalue.saleAttrValueName }}</dd>
